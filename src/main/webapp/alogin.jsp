          ...
          <div class="card-body">
            <form method="post" action="ALogin">
              <div class="form-group">
                <label for="username">Your Employee Id</label>
                <input type="text" class="form-control" name="username" id="username" placeholder="Enter your Employee Id">
              </div>
              <div class="form-group">
            ...
            <div class="text-center">
              <a href="asignup.jsp">Create an account</a>
            </div>
          </div>
        </div>
      </div>
